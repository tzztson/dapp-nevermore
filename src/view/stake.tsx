        ...
        <Box className={classes.mainBoard}>
          ...
          <Box className={classes.handleStake}>
            ...
            <Box className={classes.stakeAmount}>
              <InputBase placeholder="0" className={classes.amountInput} />
        ...
        <Box className={classes.handleBoard}>
          <Box className={classes.handleContainer}>
            ...
            <Box className={classes.labelContainer}>
              ...
              <Typography className={classes.balance}>0.00000 $WD</Typography>
            </Box>
            <Box className={classes.labelContainer}>
              <Typography className={classes.label}>
                Estimated Rewards
              </Typography>
              <Typography className={classes.balance}>0.0000 WETH</Typography>
            </Box>
            <Box className={classes.handleButtongroup}>
              <Button className={classes.handleButton}>ClaimReward</Button>
              <Button className={classes.handleButton}>Withdraw</Button>
              <Button className={classes.handleButton}>Referral</Button>
            </Box>
          </Box>
        </Box>
      </Box>
